...
/***********************************************************************************
 * Service Name: Dio_WritePort(Dio_PortType PortId, Dio_PortLevelType Level);
 *
************************************************************************************/
...
/***********************************************************************************
 *
 *     Service Name: Dio_ReadPort(Dio_PortType PortId)
 ***********************************************************************************/
Dio_PortLevelType Dio_ReadPort(Dio_PortType PortId)
{
	uint8 * PIN_Ptr = NULL_PTR;
	Dio_PortLevelType output ;
		uint8 error = FALSE;
...
Dio_PortLevelType Dio_ReadChannelGroup(const Dio_ChannelGroupType* ChannelGroupIdPtr )
{
			...
			/* Check if the used channel is within the valid range */
			while(counter<DIO_CONFIGURED_GROUPS)
			{
              if((ChannelGroupIdPtr->PortIndex==Dio_ChannelGroups[counter].PortIndex)&&
            	 (ChannelGroupIdPtr->mask==Dio_ChannelGroups[counter].mask)&&
				 (ChannelGroupIdPtr->offset==Dio_ChannelGroups[counter].offset))
              {
            	  flag=TRUE;
              }
