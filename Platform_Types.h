/*
 *  module : common - platform_abstraction
 *  file_name: platform_type,h
 *  description: 1-contain Target dependent type definitions
 *               2-contain definitions of endianess and types
